...
export default function Navbar() {
  ...
  return (
    <nav className="z-50 fixed top-0 left-0 right-0 px-4 py-5 bg-white font-Montserrat w-full flex flex-wrap items-center justify-between shadow overflow-x-hidden sm:px-16">
      <div>
        <Link to="#">
