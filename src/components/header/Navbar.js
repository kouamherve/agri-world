...
export default function Navbar() {
  ...
  return (
    <div className=" relative  font-Montserrat">
      <nav className="z-50 fixed top-0 left-0 right-0 p-2.5 bg-white w-full flex flex-wrap items-center justify-between shadow overflow-x-hidden sm:px-14 md:px-20 md:py-3.5 lg:px-14 lg:flex-nowrap lg:py-4 xl:py-5 xl:px-36 2xl:px-[710px]">
        <div>
          <Link to="#">
