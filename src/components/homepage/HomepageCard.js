  ...
  return (
    <div className="w-full h-[345px] flex justify-center items-center relative sm:h-[520px] md:h-[640px] lg:h-screen">
      ...
      <div className="absolute inset-0 mx-4 flex flex-col justify-center items-start capitalize font-Montserrat sm:mx-14 md:mx-20 lg:mx-14 lg:mt-4 xl:mx-36 xl:mt-0 xl:-top-32 2xl:mx-[266px]">
        ...
        <p className="text-white text-[31px] font-extrabold mb-5 sm:text-[40px] md:text-5xl md:leading-snug lg:mb-8 lg:max-w-2xl xl:text-7xl xl:max-w-3xl xl:mt-2 xl:leading-tight 2xl:text-[74px]">
          {slide.title}
        </p>
