  ...
  return (
    <div className="w-full h-[345px] flex justify-center items-center relative sm:h-[520px] md:h-[640px] lg:h-screen">
      <img
        ...
        alt={slide.title}
      />
      <div className="absolute inset-0 mx-4 flex flex-col justify-center items-start capitalize font-Montserrat sm:mx-14 md:mx-20 lg:mx-14 lg:mt-4 xl:mx-36 xl:mt-0 xl:-top-32">
        <h3 className="text-white text-sm mb-2 font-light sm:text-base md:text-lg md:mb-0 xl:text-lg">
          {slide.subTitle}
        </h3>
        <p className="text-white text-[32px] leading-snug font-extrabold mb-6 sm:text-[40px] md:text-5xl md:leading-snug lg:mb-8 lg:max-w-2xl xl:text-7xl xl:max-x-5xl xl:mt-2 xl:leading-tight">
          {slide.title}
        </p>
      ...
      <div className=" absolute my-4 mx-2 bottom-0 right-0 flex items-center justify-center sm:mb-8 sm:mx-6 xl:mb-20">
        <HomepageMiniCard
