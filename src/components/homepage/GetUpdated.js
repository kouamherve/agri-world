...
export default function GetUpdated() {
  ...
  return (
    <div
      className=" py-20 px-4 text-white font-Montserrat capitalize bg-cover bg-bottom bg-black/65 bg-blend-darken sm:py-24 sm:px-14 md:bg-center md:px-20 lg:px-14 xl:px-36"
