...
export default function GetUpdated() {
  ...
  return (
    <div
      className=" py-20 px-4 text-white font-Montserrat capitalize bg-cover bg-center bg-black/75 bg-blend-darken sm:py-24 sm:px-14 md:px-20 lg:px-14 xl:px-36 xl:py-28 2xl:px-[266px] 3xl:px-[710px]"
