...
export default function HomepageMiniCard({ image, title }) {
  return (
    <div className="h-14 w-20 bg-white p-2 ml-5 rounded-lg font-Montserrat flex flex-col items-center justify-center xs:h-10 xs:w-[68px] xm:h-[44px] xm:w-[76px] ss:h-16 sm:w-32 sm:p-3 sm:h-40 md:h-[140px] md:w-32 md:ml-5 lg:h-[200px] lg:w-[190px] xl:w-72 xl:p-5 2xl:h-[200px] 2xl:w-[296px]">
