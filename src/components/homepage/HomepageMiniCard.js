...
export default function HomepageMiniCard({ image, title }) {
  return (
    <div className="h-14 w-20 bg-white p-2 ml-5 rounded-lg font-Montserrat flex flex-col items-center justify-center sm:w-[136px] sm:p-3 sm:h-40 ">
      <div className="w-full h-full sm:h-2/5">
        <img
