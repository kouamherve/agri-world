...
export default function HomepageMiniCard({ image, title }) {
  return (
    <div className="h-14 w-20 bg-white p-2 ml-5 rounded-lg font-Montserrat flex flex-col items-center justify-center max-[320px]:h-10 max-[320px]:w-[68px] max-[425px]:h-[44px] max-[425px]:w-[76px] sm:w-32 sm:p-3 sm:h-32 md:h-[140px] md:w-32 md:ml-5 lg:h-[200px] lg:w-[190px] xl:w-72 xl:p-5 2xl:h-[200px] 2xl:w-[296px]">
