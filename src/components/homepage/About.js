    ...
    <div className=" bg-secondary py-14 lg:flex items-center lg:px-14 lg:py-24 gap-6">
      <div className=" mx-4 pb-8 font-Montserrat capitalize sm:mx-16 md:mx-8 lg:mx-0 lg:w-1/2 lg:pb-0">
        <div>
          ...
          <h1 className=" text-[26px] leading-snug font-bold sm:text-4xl lg:text-[34px] lg:leading-snug lg:mt-1">
            A new way to invest <br className="hidden md:block lg:hidden" />
            in agriculture
          </h1>
        </div>
        <p className=" text-[15px] text-gray-600 mt-4 mb-8 lg:text-base">
