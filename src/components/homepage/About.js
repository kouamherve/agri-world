...
export default function About() {
  return (
    <div className=" bg-secondary py-14 items-center gap-6 sm:py-16 md:py-20 lg:flex lg:px-14 lg:py-24">
      <div className=" mx-4 pb-8 font-Montserrat capitalize sm:mx-14 md:mx-20 lg:mx-0 lg:w-1/2 lg:pb-0">
        <div>
          ...
          <h1 className=" text-[26px] leading-snug font-bold sm:text-3xl md:text-4xl lg:text-[34px] lg:leading-snug lg:mt-1">
            A new way to invest <br className="hidden md:block lg:hidden" />
            in agriculture
          </h1>
        </div>
        <p className=" text-[15px] text-gray-600 mt-4 mb-8 sm:text-base lg:text-base">
      ...
      <div className="relative mx-4 h-64 sm:mx-14 sm:h-80 md:mx-20 md:h-96 lg:w-1/2 lg:mx-0">
        <img
