...
export default function BeforeAndAfter() {
  return (
    <div className=" bg-secondary py-20 space-y-6 sm:space-y-4 md:flex md:space-y-0 lg:py-24 lg:px-14">
      <div className=" relative mx-4 h-64 sm:mx-16 sm:h-[270px] md:h-72 md:mr-2 lg:mx-0 lg:h-96">
        <img
      ...
      <div className=" relative mx-4 h-64 sm:mx-16 sm:h-[270px] md:h-72 md:ml-2 lg:mx-0 lg:h-96 ">
        <img
